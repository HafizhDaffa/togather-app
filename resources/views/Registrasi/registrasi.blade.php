                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="form-group pb-3">
                              ...
                              <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Bidang Keahlian">
                            </div>
                            <div class="form-group pb-3">
                            ...
                            <div class="signup pb-3">
                                <div>Sudah punya akun? <a href="{{ url('/login') }}">Login disini</a></div>
                            </div>
                            <div class="col-md-12 text-center py-3">
                              <a class="btn btn-primary btn-light px-4" href="{{ url('/home') }}" role="button">Daftar</a>
                            </div>
                        </form>
                    </div>
                  </div>
